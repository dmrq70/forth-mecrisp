...
+ dint                  ; Just for sure, deactivate everything that could interrupt this.
  ...
  mov #0A502h, &SYSCFG0 ; Enable write access
...
- mov #0FFFFh, @r7
  ...
  ; Finished.
  ; mov #0A503h, &SYSCFG0 ; Disable write access again - not necessary before Reset
...
+ mov #0A503h, &SYSCFG0 ; Disable write access again

+ pop r10
  ret


  include "../common/extendedmemory.asm"
